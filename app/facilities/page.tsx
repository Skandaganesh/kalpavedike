...
const hallDetails: Record<LocaleType, string[]> = {
  en: [
    "Shri Daivaraja babbuswamy kalpavedike in Hariharapallathadka offers a hall suitable for various functions, including marriages, upanayanas, and other ceremonies. The hall can accommodate between 600-800 guests.",
    ...
    "Address: Shri Daivaraja babbuswamy kalpavedike, Hariharapallathadka Post and Village, Sullia Taluk, Dakshina Kannada, PIN - 574218",
  ],
  kn: [
    "ಹರಿಹರಪಲ್ಲತ್ತಡ್ಕದ ಶ್ರೀ ದೈವರಾಜ ಬಬ್ಬುಸ್ವಾಮಿ ಕಲ್ಪವೇದಿಕೆದಲ್ಲಿ ವಿವಿಧ ಕಾರ್ಯಕ್ರಮಗಳಿಗೆ, ವಿಶೇಷವಾಗಿ ಮದುವೆಗಳು, ಉಪನಯನ ಮತ್ತು ಇತರ ಸಮಾರಂಭಗಳಿಗೆ ಸುಸಜ್ಜಿತ ಸಭಾಂಗಣದ ವ್ಯವಸ್ಥೆಯಿದೆ.",
    "ಹೆಚ್ಚಿನ ಮಾಹಿತಿಗಾಗಿ ಅಥವ ಸಭಾಂಗಣ ಕಾಯ್ದಿರಿಸಲು, ದೈವಸ್ಥಾನದ ಕಚೇರಿಯನ್ನು ಸಂಪರ್ಕಿಸಬಹುದು:",
    "ದೂರವಾಣಿ: 08257 283366,+91 8073030594",
    "ವಿಳಾಸ: ಶ್ರೀ ದೈವರಾಜ ಬಬ್ಬುಸ್ವಾಮಿ ಕಲ್ಪವೇದಿಕೆ, ಹರಿಹರಪಲ್ಲತ್ತಡ್ಕ, ಸುಳ್ಯ ತಾಲೂಕು, ದಕ್ಷಿಣ ಕನ್ನಡ, ಪಿನ್ - 574218",
  ],
};
