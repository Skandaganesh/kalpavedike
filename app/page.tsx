...
const welcomeTitle: Record<LocaleType, string> = {
  ...
  kn: "ಶ್ರೀ ದೈವರಾಜ ಬಬ್ಬುಸ್ವಾಮಿ  ಶ್ರೀ ಕಲ್ಪವೇದಿಕೆಗೆ ಸ್ವಾಗತ",
};

const welcomeContent: Record<LocaleType, string> = {
  en: "Shri Daivaraja babbuswamy kalpavedike",
  kn: "ಶ್ರೀ ದೈವರಾಜ ಬಬ್ಬುಸ್ವಾಮಿ  ಶ್ರೀ ಕಲ್ಪವೇದಿಕೆ- ಈ ನೆಲದ ಚೈತನ್ಯವನ್ನು, ಈ ನೆಲದ ಶಕ್ತಿಯನ್ನು ಕಾಯ್ದುಕೊಂಡು ಬಂದಿರುವಂತಹ ದೈವರಾಜ ಬಬ್ಬುಸ್ವಾಮಿಯನ್ನೇ ಕೇಂದ್ರವಾಗಿರಿಸಿಕೊಂಡು, ಅವನ ಪದಪಯೋಜಗಳಿಗೆ ಮುಡಿಚಾಚುತ್ತಾ, ಆ ಶಕ್ತಿಯನ್ನು ಒಪ್ಪಿಕೊಳ್ಳುತ್ತಾ, ಆ ಶಕ್ತಿಯ ಆಶೀರ್ವಾದ ಬಲದಿಂದಲೇ ಎಲ್ಲ ಸುಶಿಕ್ಷಿತ ಮನಸ್ಸುಗಳು ಒಟ್ಟಾಗಿ ಒಂದು ಸಂಸ್ಥೆಯನ್ನೂ, ಒಂದು ಸಂಘಟನೆಯನ್ನು ಹುಟ್ಟುಹಾಕಿ, ತನ್ಮೂಲಕ ಜನಪರವಾದಂತಹ ಹಾಗೂ ಎಲ್ಲರ ಹೃದಯಕ್ಕೆ ತಂಪೆ ಸಗುವಂತಹ ಕಾರ್ಯಕ್ರಮಗಳ ಯೋಜನೆ, ಯೋಚನೆಗಳಿಂದ ಮುನ್ನಡೆಯುತ್ತಾ ಇದೆ.",
};
